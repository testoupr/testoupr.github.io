...
If you want the rows/columns labeled with documents and keywords:

$$
D =
\begin{array}{c c}
& \begin{array}{c c c c} w_1 & w_2 & \cdots & w_m \end{array} \\
\begin{array}{c c c c} d_1 \\ d_2 \\ \vdots \\ d_n \end{array} &
\left[
\begin{array}{c c c c}
d_{11} & d_{12} & \cdots & d_{1m} \\
d_{21} & d_{22} & \cdots & d_{2m} \\
